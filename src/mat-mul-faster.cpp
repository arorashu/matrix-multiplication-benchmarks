...
//     SquareMatrix(vector<vector<int>> &matValues)
//     {
//         values = matValues;
//     }
...
//         vector<vector<int>> *values1 = &values;
//         vector<vector<int>>  *values2 = matrix2.getValues();
...
//             {
//                 resultMatrix[i][j] = (*values1)[i][j] + (*values2)[i][j];
//             }
//         }
//         return resultMatrix;
